...
class Type2 extends StatelessWidget {
  ...
  double? height;
  BoxFit? fit;
  Type2({super.key,required this.img,required this.glowColor,required this.catName,required this.startingP,required this.bgColor,required this.height,required this.fit});
